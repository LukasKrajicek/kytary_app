...
<section class="py-5 text-center">
    <h1 class="display-4 fw-bold text-dark">Vyber si ideální kytaru nebo aparaturu</h1>
...
<!-- TŘI HLAVNÍ BOXY - Přehled hlavních sekcí -->
<div class="row text-center">
    ...
    <div class="col-md-4 mb-4">
        <div class="p-4 bg-dark text-white rounded-3 shadow">
            ...
            <a href="kytary.php" class="btn btn-outline-warning">Prozkoumat</a>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="p-4 bg-dark text-white rounded-3 shadow">
            ...
            <a href="aparatura.php" class="btn btn-outline-warning">Zobrazit</a>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="p-4 bg-dark text-white rounded-3 shadow">
            ...
            <a href="pruvodce.php" class="btn btn-outline-warning">Spustit</a>
        </div>
    </div>
